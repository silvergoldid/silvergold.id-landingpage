        ...
        <div className="grid md:grid-cols-3 gap-8 pb-8 border-b border-border">
          ...
          <div className="flex flex-col space-y-3 items-start md:items-center">
            ...
            >
              ...
              <span className="text-sm md:text-base">@silvergold.id_</span>
            </a>
            <a
            ...
            >
              ...
              <span className="text-sm md:text-base">hi@silvergold.id</span>
            </a>
          </div>
          ...
          <div className="flex flex-col md:items-end space-y-3">
            ...
            <div className="flex items-start gap-2 text-muted-foreground md:text-right">
              ...
              <span className="text-sm md:text-base">Tangerang Selatan</span>
            </div>
            <div className="flex items-center gap-2 text-muted-foreground">
              <Clock className="h-5 w-5 text-gold md:order-2" />
              <span className="text-sm md:text-base">Setiap Hari, 24 Jam</span>
            </div>
            <div className="flex items-center gap-2 text-muted-foreground">
              <MessageCircle className="h-5 w-5 text-gold md:order-2" />
              <span className="text-sm md:text-base">{formattedPhone}</span>
            </div>
          </div>
        </div>
